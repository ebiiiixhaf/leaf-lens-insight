...
const features = [
  {
    ...
    description: "Our AI analyzes your plant photos in seconds to identify over 50 common plant diseases and disorders.",
    icon: (
  ...
  },
  {
    ...
    description: "Get customized treatment recommendations based on the specific disease, plant type, and severity of the condition.",
    icon: (
      <svg className="w-12 h-12 text-leaf-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: "Learn how to prevent future outbreaks with tailored guidance for your specific plants and growing conditions.",
    icon: (
      <svg className="w-12 h-12 text-leaf-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
