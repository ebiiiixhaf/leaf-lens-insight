            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input id="lastName" defaultValue="Gardener" />
                </div>
              </div>
              <div>
                <Label htmlFor="email">Email</Label>
                <Input id="email" type="email" defaultValue="jane.gardener@email.com" />
              </div>
              <div>
              ...
              <div>
                ...
                <Input id="address" defaultValue="456 Garden Street, City, State 67890" />
              </div>
            </CardContent>
          </Card>
